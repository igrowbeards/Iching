class Hexagram
    def khien
      khien = <<-'HEX'
        ...
        Originating from the term, piercing advantageous, right and firm.
        ...
        (If all this heavenly hosts of dragons lacked their heads,
        good fortune would become a fact.)
      HEX
    end
    ...
    def khwan
      khwan = <<-'HEX'
        ...
        Great, originating, right and fair, piercing and helpful, firm as in the mare.
        If the true man should move, his feet will stray - for him to follow is his proper way.
        
        Hoar-frost!
        The strong one cometh by and by.
    ...
    def hsu
      hsu = <<-'HEX'
        ...
        Still wait, midst blood.
        Forth from cavern hie!
    ...
    def pi
      pi = <<-'HEX'
        ...
        Sincerity of union is the key - From inward mind comes forth true unity.
    ...
    def li
      li = <<-'HEX'
        ...
        Follow the path of thine accustomed right - Level and easy walks the anchorite.
        Learn vanity, the brave's bluff, to flee!
        Tread on the tiger's tail - he will not bite.
        Firm, resolute - yet perilous thy plight - Examine well, the augury of the flight.
      HEX
    end
    ...
    def ta yu
      ta yu = <<-'HEX'
        ...
        Great havings - wealth's a sorceress, within whose cauldron bubbles up succes.
        
        Steer clear of wrong, envision clear thy road.
        Lo!
        The great wagon with its golden load!
    ...
    def chien
      chien = <<-'HEX'
        ...
        Humility - this yeast's to baking. A man may win in every undertaking.
        
        Increase humilities - so clears the way!
        Once recognized, who is there to gainsay? Acknowledged merit will success inherit.
    ...
    def yu
      yu = <<-'HEX'
        ...
        Satisfaction spreads through all thy coasts. Appoint thy princes, and send forth thy hosts!
        
        Boast not of pleasure!
        There lurks overthrow.
    ...
    def sui
      sui = <<-'HEX'
        ...
        Follow after - but in following checked by being firm, unwavering and correct.
    ...
    def ku
      ku = <<-'HEX'
        ...
        Service. Thou mayst cross the stream no doubt, if thou have fully thought thy purpose out.
        
        Good son, repair thy sire's infirmity - Be gentle with thy mother's frailty, Son.
    ...
    def lin
      lin = <<-'HEX'
        ...
        Great - here's progress and success to firm correctness - but - more trouble at the term!
    ...
    def shih ho
      shih ho = <<-'HEX'
        ...
        Nip crime in the bud - lop toes, put feet in stocks - Else - flesh and nose must next be bitten through.
    ...
    def po
      po = <<-'HEX'
        ...
        Injure the couch's legs, soon all will go - Injure its frame, soon total overthrow.
        Destroy, when need is - will not wisdom show? The couch destroyed, its occupant hath woe.
    ...
    def hsien
      hsien = <<-'HEX'
        ...
        Would'st walk? To move thy toes alone is a flaw - But calves? 'Twere surely better to withdraw.
        Thigh's too? Cling close to leaders? Thou wilt rue it.
        Insited plans? Only thy friends pursue it.
        But shrug thy shoulders!
        God shall gladly view it.
    ...
    def hang
      hang = <<-'HEX'
        ...
        By persistance are great empires built. There is no law beyond do what thou wilt,
    ...
    def thun
      thun = <<-'HEX'
        ...
        Keep still - though tail yet show.
    ...
    def khwei
      khwei = <<-'HEX'
        ...
        Alone and disunion? Friends on highway Joined with thy minister thy course is free.
        Pigs? Ghosts? Foes? Nay!
        Go forward on the skyway.
      HEX
    end
    ...
    def kien
      kien = <<-'HEX'
        ...
        Advance not!
        Wait for aid from the great man!
    ...
    def kau
      kau = <<-'HEX'
        ...
        No fish - because thou hast mixed with thieves,
        in fine conceal thy virtues - cellars ripen wine!
    ...
    def zhui
      zhui = <<-'HEX'
        ...
        Success excuses boldness
        recollect then to be firm in virtue and correct!
    ...
    def chen
      chen = <<-'HEX'
        ...
        Fire!
        Beware, but smile with mein divine!
    ...
    def kan
      kan = <<-'HEX'
        ...
        Earth - keep silence like thy spine!
        See none about thee!
        Thus the silk of wisdom's spun.
    ...
    def fang
      fang = <<-'HEX'
        ...
        Mated in darkness - men!
        'Tis fortune's source.
    ...
    def kieh
      kieh = <<-'HEX'
        ...
        Regulations.
        Who can do without them? But not too many, lest men come to flout them!
        Quit not thine house to meddle with the state - But set good order still within thy gate.
        Thou mayest lament if thou should'st disobey.
        But keep the law and go thy peaceful way.
        Enact thy laws - suave, tactful, moderate - But vex not men with harshness overweigh!
    ...
    def hsiao kwo
      hsiao kwo = <<-'HEX'
        ...
        The issue's evil when birds soar too high - The wisest course is humble loyalty.
        Without precautions, enemies assail - But adaptation and sound care prevail.
        Birds in a cave - sure marks for archer's eye! Ambition, in bad times, is lunacy.
        Winged though thou be, soar not too rashly high! Let not self seeking out run loyalty!
        Men be incaution ask their foes to assail - Tact and adroitness helps one to prevail.
        At easiest mark, let thine arrows fly!  Uncurbed ambition courts calamity.
      HEX
    end
    ...
    def wei zi
      wei zi = <<-'HEX'
        ...
        Work ruined!
        Ah so nearly crossed the stream!
        Step slackly once, and all is lost!
